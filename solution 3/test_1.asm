...
main(int argc, char* argv[])
{
   ...
   e:	53                   	push   %ebx
    ...
    if (getpinfo(s) == -1)
   f:	8d b5 e8 f8 ff ff    	lea    -0x718(%ebp),%esi
  15:	51                   	push   %ecx
  16:	81 ec 0c 07 00 00    	sub    $0x70c,%esp
    int mypid = getpid();
  1c:	e8 e2 03 00 00       	call   403 <getpid>
    if (getpinfo(s) == -1)
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (getpinfo(s) == -1)
  27:	e8 ff 03 00 00       	call   42b <getpinfo>
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	83 f8 ff             	cmp    $0xffffffff,%eax
  32:	0f 84 a4 00 00 00    	je     dc <main+0xdc>
        return -1;
    
    // Find an entry matching my pid
    for (int i = 0; i < NPROC; i++)
  38:	31 c0                	xor    %eax,%eax
  3a:	eb 10                	jmp    4c <main+0x4c>
  3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  40:	83 c0 01             	add    $0x1,%eax
  43:	83 f8 40             	cmp    $0x40,%eax
  46:	0f 84 90 00 00 00    	je     dc <main+0xdc>
        if (s->pid[i] == mypid)
  4c:	3b 9c 86 00 02 00 00 	cmp    0x200(%esi,%eax,4),%ebx
  ...
  55:	8b 94 85 e8 f8 ff ff 	mov    -0x718(%ebp,%eax,4),%edx
  5c:	85 d2                	test   %edx,%edx
  5e:	74 57                	je     b7 <main+0xb7>

    ASSERT(ps.tickets[my_idx] == DEFAULT_TICKETS, "My ticekts (%d) does not match \
  60:	83 bc 85 e8 f9 ff ff 	cmpl   $0x8,-0x618(%ebp,%eax,4)
  67:	08 
  68:	8d 58 40             	lea    0x40(%eax),%ebx
  6b:	0f 84 90 00 00 00    	je     101 <main+0x101>
  71:	83 ec 0c             	sub    $0xc,%esp
  74:	6a 11                	push   $0x11
  76:	68 18 08 00 00       	push   $0x818
  7b:	68 21 08 00 00       	push   $0x821
  80:	68 2b 08 00 00       	push   $0x82b
  85:	6a 01                	push   $0x1
  87:	e8 64 04 00 00       	call   4f0 <printf>
  8c:	83 c4 20             	add    $0x20,%esp
  8f:	6a 08                	push   $0x8
  91:	ff b4 9d e8 f8 ff ff 	push   -0x718(%ebp,%ebx,4)
  98:	68 a0 08 00 00       	push   $0x8a0
    ASSERT(ps.inuse[my_idx], "My slot in the ptable is not in use!");
  9d:	6a 01                	push   $0x1
  9f:	e8 4c 04 00 00       	call   4f0 <printf>
  a4:	5b                   	pop    %ebx
  a5:	5e                   	pop    %esi
  a6:	68 35 08 00 00       	push   $0x835
  ab:	6a 01                	push   $0x1
  ad:	e8 3e 04 00 00       	call   4f0 <printf>
  b2:	e8 cc 02 00 00       	call   383 <exit>
  b7:	83 ec 0c             	sub    $0xc,%esp
  ba:	6a 0f                	push   $0xf
  bc:	68 18 08 00 00       	push   $0x818
  c1:	68 21 08 00 00       	push   $0x821
  c6:	68 2b 08 00 00       	push   $0x82b
  cb:	6a 01                	push   $0x1
  cd:	e8 1e 04 00 00       	call   4f0 <printf>
  d2:	83 c4 18             	add    $0x18,%esp
  d5:	68 78 08 00 00       	push   $0x878
  da:	eb c1                	jmp    9d <main+0x9d>
    ASSERT(my_idx != -1, "Could not get process stats from pgetinfo");
  dc:	83 ec 0c             	sub    $0xc,%esp
  df:	6a 0d                	push   $0xd
  e1:	68 18 08 00 00       	push   $0x818
  e6:	68 21 08 00 00       	push   $0x821
  eb:	68 2b 08 00 00       	push   $0x82b
  f0:	6a 01                	push   $0x1
  f2:	e8 f9 03 00 00       	call   4f0 <printf>
  f7:	83 c4 18             	add    $0x18,%esp
  fa:	68 4c 08 00 00       	push   $0x84c
  ff:	eb 9c                	jmp    9d <main+0x9d>
    return -1;
}
...
static void test_passed() {
 ...
 101:	51                   	push   %ecx
 102:	68 21 08 00 00       	push   $0x821
 107:	68 37 08 00 00       	push   $0x837
 10c:	6a 01                	push   $0x1
 10e:	e8 dd 03 00 00       	call   4f0 <printf>
 113:	83 c4 0c             	add    $0xc,%esp
 116:	68 3c 08 00 00       	push   $0x83c
 11b:	68 48 08 00 00       	push   $0x848
 120:	e9 78 ff ff ff       	jmp    9d <main+0x9d>
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 50 09 00 00 	movzbl 0x950(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 f8 08 00 00 	jmp    *0x8f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba ee 08 00 00       	mov    $0x8ee,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 00 0c 00 00       	mov    0xc00,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 00 0c 00 00    	mov    %edx,0xc00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 00 0c 00 00    	mov    0xc00,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 00 0c 00 00 04 	movl   $0xc04,0xc00
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 04 0c 00 00       	mov    $0xc04,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 04 0c 00 00 04 	movl   $0xc04,0xc04
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 802:	00 00 00 
    if(p->s.size >= nunits){
