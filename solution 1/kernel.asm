...
80100cf8:	e8 e3 65 00 00       	call   801072e0 <copyout>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 78 65 00 00       	call   801072e0 <copyout>
...
80103022:	e8 e9 2a 00 00       	call   80105b10 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 b5 3b 00 00       	call   80106c00 <switchkvm>
  seginit();
8010304b:	e8 20 3b 00 00       	call   80106b70 <seginit>
  lapicinit();
...
80103081:	e8 6a 40 00 00       	call   801070f0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 db 3a 00 00       	call   80106b70 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 57 2d 00 00       	call   80105e00 <uartinit>
  pinit();         // process table
801030a9:	e8 52 08 00 00       	call   80103900 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 dd 29 00 00       	call   80105a90 <tvinit>
  binit();         // buffer cache
...
801037e9:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  ...
  p->stride = calculate_stride(p->tickets);
  p->pass = 0;
  release(&ptable.lock);
...
801037f1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 8;  // Default ticket value
801037f8:	c7 43 7c 08 00 00 00 	movl   $0x8,0x7c(%ebx)
  p->pid = nextpid++;
801037ff:	89 43 10             	mov    %eax,0x10(%ebx)
80103802:	8d 50 01             	lea    0x1(%eax),%edx
  p->stride = calculate_stride(p->tickets);
80103805:	c7 83 80 00 00 00 e2 	movl   $0x4e2,0x80(%ebx)
8010380c:	04 00 00 
  p->pass = 0;
...
80103819:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
8010381e:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103824:	e8 97 0e 00 00       	call   801046c0 <release>
...
80103846:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103849:	c7 40 14 77 5a 10 80 	movl   $0x80105a77,0x14(%eax)
  p->context = (struct context*)sp;
...
80103858:	e8 83 0f 00 00       	call   801047e0 <memset>
...
80103882:	e8 39 0e 00 00       	call   801046c0 <release>
}
...
801038bb:	e8 00 0e 00 00       	call   801046c0 <release>
...
80103906:	68 00 79 10 80       	push   $0x80107900
8010390b:	68 20 1d 11 80       	push   $0x80111d20
80103910:	e8 3b 0c 00 00       	call   80104550 <initlock>
}
...
80103920 <calculate_stride>:
calculate_stride(int tickets) {
80103920:	55                   	push   %ebp
  return STRIDE1 / tickets;
80103921:	b8 10 27 00 00       	mov    $0x2710,%eax
80103926:	99                   	cltd   
calculate_stride(int tickets) {
80103927:	89 e5                	mov    %esp,%ebp
  return STRIDE1 / tickets;
80103929:	f7 7d 08             	idivl  0x8(%ebp)
}
8010392c:	5d                   	pop    %ebp
8010392d:	c3                   	ret    
...
801039b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039b7:	e8 14 0c 00 00       	call   801045d0 <pushcli>
  c = mycpu();
801039bc:	e8 6f ff ff ff       	call   80103930 <mycpu>
  p = c->proc;
801039c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c7:	e8 54 0c 00 00       	call   80104620 <popcli>
}
...
801039ec:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ee:	a3 54 41 11 80       	mov    %eax,0x80114154
  if((p->pgdir = setupkvm()) == 0)
801039f3:	e8 78 36 00 00       	call   80107070 <setupkvm>
...
80103a11:	e8 0a 33 00 00       	call   80106d20 <inituvm>
...
80103a26:	e8 b5 0d 00 00       	call   801047e0 <memset>
...
80103a7f:	68 30 79 10 80       	push   $0x80107930
80103a84:	50                   	push   %eax
80103a85:	e8 16 0f 00 00       	call   801049a0 <safestrcpy>
  p->cwd = namei("/");
80103a8a:	c7 04 24 39 79 10 80 	movl   $0x80107939,(%esp)
...
80103ac3:	68 17 79 10 80       	push   $0x80107917
...
80103ad5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ad8:	e8 f3 0a 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103add:	e8 4e fe ff ff       	call   80103930 <mycpu>
  p = c->proc;
80103ae2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ae8:	e8 33 0b 00 00       	call   80104620 <popcli>
  sz = curproc->sz;
...
80103afb:	e8 10 31 00 00       	call   80106c10 <switchuvm>
  return 0;
...
80103b1a:	e8 71 33 00 00       	call   80106e90 <allocuvm>
...
80103b3a:	e8 81 34 00 00       	call   80106fc0 <deallocuvm>
...
80103b56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b59:	e8 72 0a 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103b5e:	e8 cd fd ff ff       	call   80103930 <mycpu>
  p = c->proc;
80103b63:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b69:	e8 b2 0a 00 00       	call   80104620 <popcli>
  if((np = allocproc()) == 0){
...
80103b88:	e8 d3 35 00 00       	call   80107160 <copyuvm>
...
80103c73:	57                   	push   %edi
  return STRIDE1 / tickets;
80103c74:	bf 10 27 00 00       	mov    $0x2710,%edi
{
80103c79:	56                   	push   %esi
80103c7a:	53                   	push   %ebx
80103c7b:	83 ec 1c             	sub    $0x1c,%esp
    struct cpu *c = mycpu();
80103c7e:	e8 ad fc ff ff       	call   80103930 <mycpu>
    c->proc = 0;
80103c83:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103c8a:	00 00 00 
    struct cpu *c = mycpu();
80103c8d:	89 c3                	mov    %eax,%ebx
    c->proc = 0;
80103c8f:	8d 40 04             	lea    0x4(%eax),%eax
...
80103c9c:	68 20 1d 11 80       	push   $0x80111d20
80103ca1:	e8 7a 0a 00 00       	call   80104720 <acquire>
80103ca6:	83 c4 10             	add    $0x10,%esp
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103ca9:	b9 54 1d 11 80       	mov    $0x80111d54,%ecx
80103cae:	66 90                	xchg   %ax,%ax
            if (p->state == RUNNABLE) {
80103cb0:	83 79 0c 03          	cmpl   $0x3,0xc(%ecx)
80103cb4:	75 0c                	jne    80103cc2 <scheduler+0x52>
  return STRIDE1 / tickets;
80103cb6:	89 f8                	mov    %edi,%eax
80103cb8:	99                   	cltd   
80103cb9:	f7 79 7c             	idivl  0x7c(%ecx)
                p->stride = calculate_stride(p->tickets);
80103cbc:	89 81 80 00 00 00    	mov    %eax,0x80(%ecx)
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103cc2:	81 c1 90 00 00 00    	add    $0x90,%ecx
80103cc8:	81 f9 54 41 11 80    	cmp    $0x80114154,%ecx
80103cce:	75 e0                	jne    80103cb0 <scheduler+0x40>
        min_pass_proc = 0;
80103cd0:	31 f6                	xor    %esi,%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103cd2:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103cd7:	eb 22                	jmp    80103cfb <scheduler+0x8b>
80103cd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            if (min_pass_proc == 0 || p->pass < min_pass_proc->pass)
80103ce0:	8b 96 84 00 00 00    	mov    0x84(%esi),%edx
80103ce6:	39 90 84 00 00 00    	cmp    %edx,0x84(%eax)
80103cec:	0f 4c f0             	cmovl  %eax,%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103cef:	05 90 00 00 00       	add    $0x90,%eax
80103cf4:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80103cf9:	74 1d                	je     80103d18 <scheduler+0xa8>
            if (p->state != RUNNABLE)
80103cfb:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103cff:	75 ee                	jne    80103cef <scheduler+0x7f>
            if (min_pass_proc == 0 || p->pass < min_pass_proc->pass)
80103d01:	85 f6                	test   %esi,%esi
80103d03:	75 db                	jne    80103ce0 <scheduler+0x70>
80103d05:	89 c6                	mov    %eax,%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d07:	05 90 00 00 00       	add    $0x90,%eax
80103d0c:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80103d11:	75 e8                	jne    80103cfb <scheduler+0x8b>
80103d13:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d17:	90                   	nop
        if (min_pass_proc != 0) {
80103d18:	85 f6                	test   %esi,%esi
80103d1a:	74 5a                	je     80103d76 <scheduler+0x106>
            switchuvm(min_pass_proc);
80103d1c:	83 ec 0c             	sub    $0xc,%esp
            c->proc = min_pass_proc;
80103d1f:	89 b3 ac 00 00 00    	mov    %esi,0xac(%ebx)
            switchuvm(min_pass_proc);
80103d25:	56                   	push   %esi
80103d26:	e8 e5 2e 00 00       	call   80106c10 <switchuvm>
            min_pass_proc->state = RUNNING;
80103d2b:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
            swtch(&(c->scheduler), min_pass_proc->context);
80103d32:	58                   	pop    %eax
80103d33:	5a                   	pop    %edx
            uint start_ticks = ticks;
80103d34:	8b 0d 60 41 11 80    	mov    0x80114160,%ecx
            swtch(&(c->scheduler), min_pass_proc->context);
80103d3a:	ff 76 1c             	push   0x1c(%esi)
80103d3d:	ff 75 e0             	push   -0x20(%ebp)
            uint start_ticks = ticks;
80103d40:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
            swtch(&(c->scheduler), min_pass_proc->context);
80103d43:	e8 b3 0c 00 00       	call   801049fb <swtch>
            switchkvm();
80103d48:	e8 b3 2e 00 00       	call   80106c00 <switchkvm>
            min_pass_proc->rtime += (ticks - start_ticks);
80103d4d:	a1 60 41 11 80       	mov    0x80114160,%eax
80103d52:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            c->proc = 0;
80103d55:	83 c4 10             	add    $0x10,%esp
            min_pass_proc->rtime += (ticks - start_ticks);
80103d58:	29 c8                	sub    %ecx,%eax
80103d5a:	01 86 8c 00 00 00    	add    %eax,0x8c(%esi)
            min_pass_proc->pass += min_pass_proc->stride;
80103d60:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
80103d66:	01 86 84 00 00 00    	add    %eax,0x84(%esi)
            c->proc = 0;
80103d6c:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d73:	00 00 00 
        release(&ptable.lock);
80103d76:	83 ec 0c             	sub    $0xc,%esp
80103d79:	68 20 1d 11 80       	push   $0x80111d20
80103d7e:	e8 3d 09 00 00       	call   801046c0 <release>
    for (;;) {
...
80103df3:	e8 03 0c 00 00       	call   801049fb <swtch>
  mycpu()->intena = intena;
...
80103e59:	e8 52 fb ff ff       	call   801039b0 <myproc>
  if(curproc == initproc)
80103e5e:	39 05 54 41 11 80    	cmp    %eax,0x80114154
...
80103eba:	e8 61 08 00 00       	call   80104720 <acquire>
...
80103ed5:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
80103ee7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103eee:	05 90 00 00 00       	add    $0x90,%eax
80103ef3:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80103ef8:	75 e2                	jne    80103edc <exit+0x8c>
      p->parent = initproc;
80103efa:	8b 0d 54 41 11 80    	mov    0x80114154,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103f10:	81 c2 90 00 00 00    	add    $0x90,%edx
80103f16:	81 fa 54 41 11 80    	cmp    $0x80114154,%edx
...
80103f37:	90                   	nop
80103f38:	05 90 00 00 00       	add    $0x90,%eax
80103f3d:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
80103f67:	68 88 79 10 80       	push   $0x80107988
80103f6c:	e8 0f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f71:	83 ec 0c             	sub    $0xc,%esp
80103f74:	68 7b 79 10 80       	push   $0x8010797b
...
80103fbe:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
...
80103fd7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fdc:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
...
80103ff1:	0f 85 8f 00 00 00    	jne    80104086 <wait+0x106>
  pushcli();
80103ff7:	e8 d4 05 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103ffc:	e8 2f f9 ff ff       	call   80103930 <mycpu>
  p = c->proc;
80104001:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104007:	e8 14 06 00 00       	call   80104620 <popcli>
  if(p == 0)
...
80104049:	e8 a2 2f 00 00       	call   80106ff0 <freevm>
        p->pid = 0;
...
80104075:	e8 46 06 00 00       	call   801046c0 <release>
        return pid;
...
801040bc:	e8 5f 06 00 00       	call   80104720 <acquire>
  pushcli();
801040c1:	e8 0a 05 00 00       	call   801045d0 <pushcli>
  c = mycpu();
801040c6:	e8 65 f8 ff ff       	call   80103930 <mycpu>
  p = c->proc;
801040cb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040d1:	e8 4a 05 00 00       	call   80104620 <popcli>
...
801040e9:	e8 d2 05 00 00       	call   801046c0 <release>
}
...
8010410c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010410f:	e8 bc 04 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80104114:	e8 17 f8 ff ff       	call   80103930 <mycpu>
  p = c->proc;
80104119:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010411f:	e8 fc 04 00 00       	call   80104620 <popcli>
  if(p == 0)
...
80104140:	e8 db 05 00 00       	call   80104720 <acquire>
    release(lk);
80104145:	89 34 24             	mov    %esi,(%esp)
80104148:	e8 73 05 00 00       	call   801046c0 <release>
  p->chan = chan;
...
8010416a:	e8 51 05 00 00       	call   801046c0 <release>
    acquire(lk);
...
8010417b:	5d                   	pop    %ebp
    acquire(lk);
8010417c:	e9 9f 05 00 00       	jmp    80104720 <acquire>
...
801041a9:	68 9a 79 10 80       	push   $0x8010799a
801041ae:	e8 cd c1 ff ff       	call   80100380 <panic>
    panic("sleep");
801041b3:	83 ec 0c             	sub    $0xc,%esp
801041b6:	68 94 79 10 80       	push   $0x80107994
...
801041cf:	e8 4c 05 00 00       	call   80104720 <acquire>
...
801041e5:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
801041f7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041fe:	05 90 00 00 00       	add    $0x90,%eax
80104203:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
80104214:	c9                   	leave  
  release(&ptable.lock);
80104215:	e9 a6 04 00 00       	jmp    801046c0 <release>
...
8010422f:	e8 ec 04 00 00       	call   80104720 <acquire>
...
80104245:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
80104288:	e8 33 04 00 00       	call   801046c0 <release>
}
...
801042bb:	68 1f 7d 10 80       	push   $0x80107d1f
801042c0:	e8 db c3 ff ff       	call   801006a0 <cprintf>
801042c5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042c8:	81 c3 90 00 00 00    	add    $0x90,%ebx
801042ce:	81 fb c0 41 11 80    	cmp    $0x801141c0,%ebx
...
801042df:	74 e7                	je     801042c8 <procdump+0x28>
      state = "???";
801042e1:	ba ab 79 10 80       	mov    $0x801079ab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042e6:	83 f8 05             	cmp    $0x5,%eax
801042e9:	77 11                	ja     801042fc <procdump+0x5c>
801042eb:	8b 14 85 0c 7a 10 80 	mov    -0x7fef85f4(,%eax,4),%edx
      state = "???";
801042f2:	b8 ab 79 10 80       	mov    $0x801079ab,%eax
...
80104301:	68 af 79 10 80       	push   $0x801079af
...
80104328:	e8 43 02 00 00       	call   80104570 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010433d:	68 01 74 10 80       	push   $0x80107401
...
// System call implementation for getpinfo
...
80104364:	53                   	push   %ebx
    ...
    // Check if the user passed a valid pointer to pstat
    if (argptr(0, (void*)&ps, sizeof(*ps)) < 0)
80104365:	8d 45 08             	lea    0x8(%ebp),%eax
80104368:	83 ec 04             	sub    $0x4,%esp
8010436b:	68 00 07 00 00       	push   $0x700
80104370:	50                   	push   %eax
80104371:	6a 00                	push   $0x0
80104373:	e8 78 07 00 00       	call   80104af0 <argptr>
80104378:	83 c4 10             	add    $0x10,%esp
8010437b:	85 c0                	test   %eax,%eax
8010437d:	0f 88 8e 00 00 00    	js     80104411 <getpinfo+0xb1>
        return -1;  // Return error if argptr fails

    acquire(&ptable.lock);  // Lock the process table
80104383:	83 ec 0c             	sub    $0xc,%esp
80104386:	68 20 1d 11 80       	push   $0x80111d20
8010438b:	e8 90 03 00 00       	call   80104720 <acquire>
    // Iterate over the process table to fill in the pstat structure
    for (int i = 0; i < NPROC; i++) {
        p = &ptable.proc[i];  // Get the process pointer

        // Fill the pstat structure
        ps->inuse[i] = (p->state != UNUSED);
80104390:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104393:	b8 60 1d 11 80       	mov    $0x80111d60,%eax
80104398:	83 c4 10             	add    $0x10,%esp
    for (int i = 0; i < NPROC; i++) {
8010439b:	31 c9                	xor    %ecx,%ecx
8010439d:	8d 76 00             	lea    0x0(%esi),%esi
        ps->inuse[i] = (p->state != UNUSED);
801043a0:	8b 30                	mov    (%eax),%esi
801043a2:	31 d2                	xor    %edx,%edx
801043a4:	85 f6                	test   %esi,%esi
801043a6:	0f 95 c2             	setne  %dl
    for (int i = 0; i < NPROC; i++) {
801043a9:	05 90 00 00 00       	add    $0x90,%eax
        ps->inuse[i] = (p->state != UNUSED);
801043ae:	89 14 8b             	mov    %edx,(%ebx,%ecx,4)
        ps->tickets[i] = p->tickets;
801043b1:	8b 5d 08             	mov    0x8(%ebp),%ebx
801043b4:	8b 70 e0             	mov    -0x20(%eax),%esi
801043b7:	8d 14 8b             	lea    (%ebx,%ecx,4),%edx
    for (int i = 0; i < NPROC; i++) {
801043ba:	83 c1 01             	add    $0x1,%ecx
        ps->tickets[i] = p->tickets;
801043bd:	89 b2 00 01 00 00    	mov    %esi,0x100(%edx)
        ps->pid[i] = p->pid;
801043c3:	8b b0 74 ff ff ff    	mov    -0x8c(%eax),%esi
801043c9:	89 b2 00 02 00 00    	mov    %esi,0x200(%edx)
        ps->pass[i] = p->pass;
801043cf:	8b 70 e8             	mov    -0x18(%eax),%esi
801043d2:	89 b2 00 03 00 00    	mov    %esi,0x300(%edx)
        ps->remain[i] = p->remain;
801043d8:	8b 70 ec             	mov    -0x14(%eax),%esi
801043db:	89 b2 00 04 00 00    	mov    %esi,0x400(%edx)
        ps->stride[i] = p->stride;
801043e1:	8b 70 e4             	mov    -0x1c(%eax),%esi
801043e4:	89 b2 00 05 00 00    	mov    %esi,0x500(%edx)
        ps->rtime[i] = p->rtime;
801043ea:	8b 70 f0             	mov    -0x10(%eax),%esi
801043ed:	89 b2 00 06 00 00    	mov    %esi,0x600(%edx)
    for (int i = 0; i < NPROC; i++) {
801043f3:	83 f9 40             	cmp    $0x40,%ecx
801043f6:	75 a8                	jne    801043a0 <getpinfo+0x40>
    }

    release(&ptable.lock);  // Unlock the process table
801043f8:	83 ec 0c             	sub    $0xc,%esp
801043fb:	68 20 1d 11 80       	push   $0x80111d20
80104400:	e8 bb 02 00 00       	call   801046c0 <release>
    return 0;  // Successfully filled pstat structure
...
80104416:	eb f2                	jmp    8010440a <getpinfo+0xaa>
...
80104485:	e8 76 fc ff ff       	call   80104100 <sleep>
  while (lk->locked) {
...
80104493:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104499:	e8 12 f5 ff ff       	call   801039b0 <myproc>
...
801044e4:	e8 d7 fc ff ff       	call   801041c0 <wakeup>
  release(&lk->lk);
...
8010453b:	e8 70 f4 ff ff       	call   801039b0 <myproc>
...
801045fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104600:	e8 2b f3 ff ff       	call   80103930 <mycpu>
...
8010464c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104650:	e8 db f2 ff ff       	call   80103930 <mycpu>
...
801046a3:	e8 88 f2 ff ff       	call   80103930 <mycpu>
...
801046eb:	e8 40 f2 ff ff       	call   80103930 <mycpu>
...
8010475c:	e8 cf f1 ff ff       	call   80103930 <mycpu>
...
801047bb:	e8 70 f1 ff ff       	call   80103930 <mycpu>
...
80104a17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a1a:	e8 91 ef ff ff       	call   801039b0 <myproc>
...
80104a57:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a5a:	e8 51 ef ff ff       	call   801039b0 <myproc>
...
80104aa5:	e8 06 ef ff ff       	call   801039b0 <myproc>
...
80104ab3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ab6:	e8 f5 ee ff ff       	call   801039b0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104af6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104af9:	e8 b2 ee ff ff       	call   801039b0 <myproc>
80104afe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b00:	e8 ab ee ff ff       	call   801039b0 <myproc>
...
80104b0e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b11:	e8 9a ee ff ff       	call   801039b0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b64:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b65:	e8 46 ee ff ff       	call   801039b0 <myproc>
...
80104b73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b76:	e8 35 ee ff ff       	call   801039b0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b8b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b8e:	e8 1d ee ff ff       	call   801039b0 <myproc>
  if(addr >= curproc->sz)
...
80104be4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104be7:	e8 c4 ed ff ff       	call   801039b0 <myproc>
...
80104e10:	e8 9b eb ff ff       	call   801039b0 <myproc>
...
80104e1e:	74 20                	je     80104e40 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104e20:	e8 8b eb ff ff       	call   801039b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104e90:	e8 1b eb ff ff       	call   801039b0 <myproc>
...
80104f10:	e8 9b ea ff ff       	call   801039b0 <myproc>
...
80104fa1:	74 25                	je     80104fc8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104fa3:	e8 08 ea ff ff       	call   801039b0 <myproc>
  fileclose(f);
...
801053e7:	74 23                	je     8010540c <sys_open+0x9c>
  struct proc *curproc = myproc();
801053e9:	e8 c2 e5 ff ff       	call   801039b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055a5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055a8:	e8 03 e4 ff ff       	call   801039b0 <myproc>
...
801057b7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057ba:	e8 f1 e1 ff ff       	call   801039b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057d6:	75 f0                	jne    801057c8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801057d8:	e8 d3 e1 ff ff       	call   801039b0 <myproc>
...
{
  return fork();
80105810:	e9 3b e3 ff ff       	jmp    80103b50 <fork>
...
80105823:	83 ec 08             	sub    $0x8,%esp
  exit();
80105826:	e8 25 e6 ff ff       	call   80103e50 <exit>
...
{
  return wait();
80105830:	e9 4b e7 ff ff       	jmp    80103f80 <wait>
...
8010585e:	e8 bd e9 ff ff       	call   80104220 <kill>
...
80105883:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105886:	e8 25 e1 ff ff       	call   801039b0 <myproc>
...
801058a7:	78 27                	js     801058d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058a9:	e8 02 e1 ff ff       	call   801039b0 <myproc>
  if(growproc(n) < 0)
...
801058b6:	e8 15 e2 ff ff       	call   80103ad0 <growproc>
...
80105900:	68 80 41 11 80       	push   $0x80114180
80105905:	e8 16 ee ff ff       	call   80104720 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010590a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010590d:	8b 1d 60 41 11 80    	mov    0x80114160,%ebx
  while(ticks - ticks0 < n){
...
80105923:	68 80 41 11 80       	push   $0x80114180
80105928:	68 60 41 11 80       	push   $0x80114160
8010592d:	e8 ce e7 ff ff       	call   80104100 <sleep>
  while(ticks - ticks0 < n){
80105932:	a1 60 41 11 80       	mov    0x80114160,%eax
...
8010593f:	73 2f                	jae    80105970 <sys_sleep+0x90>
    if(myproc()->killed){
80105941:	e8 6a e0 ff ff       	call   801039b0 <myproc>
...
80105950:	68 80 41 11 80       	push   $0x80114180
...
80105973:	68 80 41 11 80       	push   $0x80114180
...
80105994:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105997:	68 80 41 11 80       	push   $0x80114180
8010599c:	e8 7f ed ff ff       	call   80104720 <acquire>
  xticks = ticks;
801059a1:	8b 1d 60 41 11 80    	mov    0x80114160,%ebx
  release(&tickslock);
801059a7:	c7 04 24 80 41 11 80 	movl   $0x80114180,(%esp)
...
801059cc:	e8 cf f0 ff ff       	call   80104aa0 <argint>
801059d1:	83 c4 10             	add    $0x10,%esp
801059d4:	85 c0                	test   %eax,%eax
801059d6:	78 3e                	js     80105a16 <sys_settickets+0x56>
    return -1;
...
801059dd:	7e 21                	jle    80105a00 <sys_settickets+0x40>
    n = 8;  // Set default if less than minimum
  } else if (n > (1 << 5)) {
801059df:	83 f8 20             	cmp    $0x20,%eax
801059e2:	7e 07                	jle    801059eb <sys_settickets+0x2b>
    n = 1 << 5;  // Set maximum limit
801059e4:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
  }

  // Set the tickets count
  myproc()->tickets = n;
801059eb:	e8 c0 df ff ff       	call   801039b0 <myproc>
801059f0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059f3:	89 50 7c             	mov    %edx,0x7c(%eax)
  //curproc->stride = TICKETS_TOTAL / curproc->tickets;
  return 0;
801059f6:	31 c0                	xor    %eax,%eax
}
801059f8:	c9                   	leave  
801059f9:	c3                   	ret    
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    n = 8;  // Set default if less than minimum
80105a00:	c7 45 f4 08 00 00 00 	movl   $0x8,-0xc(%ebp)
  myproc()->tickets = n;
80105a07:	e8 a4 df ff ff       	call   801039b0 <myproc>
80105a0c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a0f:	89 50 7c             	mov    %edx,0x7c(%eax)
  return 0;
80105a12:	31 c0                	xor    %eax,%eax
80105a14:	eb e2                	jmp    801059f8 <sys_settickets+0x38>
}
80105a16:	c9                   	leave  
    return -1;
...
80105a23:	53                   	push   %ebx
    ...
    if (argptr(0, (void*)&ps, sizeof(ps)) < 0)
80105a24:	8d 9d f8 f8 ff ff    	lea    -0x708(%ebp),%ebx
int sys_getpinfo(void) {
80105a2a:	81 ec 08 07 00 00    	sub    $0x708,%esp
    if (argptr(0, (void*)&ps, sizeof(ps)) < 0)
80105a30:	68 00 07 00 00       	push   $0x700
80105a35:	53                   	push   %ebx
80105a36:	6a 00                	push   $0x0
80105a38:	e8 b3 f0 ff ff       	call   80104af0 <argptr>
80105a3d:	83 c4 10             	add    $0x10,%esp
80105a40:	85 c0                	test   %eax,%eax
80105a42:	78 14                	js     80105a58 <sys_getpinfo+0x38>
        return -1;  // Return error if argptr fails
...
80105a48:	e8 13 e9 ff ff       	call   80104360 <getpinfo>
...
80105a5d:	eb f1                	jmp    80105a50 <sys_getpinfo+0x30>
...
80105a60:	06                   	push   %es
  pushl %fs
80105a61:	0f a0                	push   %fs
  pushl %gs
80105a63:	0f a8                	push   %gs
  pushal
80105a65:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a66:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a6a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a6c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a6e:	54                   	push   %esp
  call trap
80105a6f:	e8 cc 00 00 00       	call   80105b40 <trap>
  addl $4, %esp
80105a74:	83 c4 04             	add    $0x4,%esp
...
80105a77:	61                   	popa   
  popl %gs
80105a78:	0f a9                	pop    %gs
  popl %fs
80105a7a:	0f a1                	pop    %fs
  popl %es
80105a7c:	07                   	pop    %es
  popl %ds
80105a7d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a7e:	83 c4 08             	add    $0x8,%esp
  iret
80105a81:	cf                   	iret   
80105a82:	66 90                	xchg   %ax,%ax
80105a84:	66 90                	xchg   %ax,%ax
...
80105aa7:	c7 04 c5 c2 41 11 80 	movl   $0x8e000008,-0x7feebe3e(,%eax,8)
80105aae:	08 00 00 8e 
80105ab2:	66 89 14 c5 c0 41 11 	mov    %dx,-0x7feebe40(,%eax,8)
80105ab9:	80 
80105aba:	c1 ea 10             	shr    $0x10,%edx
80105abd:	66 89 14 c5 c6 41 11 	mov    %dx,-0x7feebe3a(,%eax,8)
80105ac4:	80 
  for(i = 0; i < 256; i++)
...
80105ad7:	c7 05 c2 43 11 80 08 	movl   $0xef000008,0x801143c2
80105ade:	00 00 ef 
  initlock(&tickslock, "time");
80105ae1:	68 41 7b 10 80       	push   $0x80107b41
80105ae6:	68 80 41 11 80       	push   $0x80114180
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aeb:	66 a3 c0 43 11 80    	mov    %ax,0x801143c0
80105af1:	c1 e8 10             	shr    $0x10,%eax
80105af4:	66 a3 c6 43 11 80    	mov    %ax,0x801143c6
  initlock(&tickslock, "time");
80105afa:	e8 51 ea ff ff       	call   80104550 <initlock>
}
...
80105b1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b1f:	b8 c0 41 11 80       	mov    $0x801141c0,%eax
...
80105b64:	ff 24 85 e8 7b 10 80 	jmp    *-0x7fef8418(,%eax,4)
...
80105b6f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b70:	e8 cb c6 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105b83:	e8 28 de ff ff       	call   801039b0 <myproc>
...
80105ba0:	e8 0b de ff ff       	call   801039b0 <myproc>
80105ba5:	85 c0                	test   %eax,%eax
80105ba7:	74 0f                	je     80105bb8 <trap+0x78>
80105ba9:	e8 02 de ff ff       	call   801039b0 <myproc>
...
80105bb2:	0f 84 b8 00 00 00    	je     80105c70 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bb8:	e8 f3 dd ff ff       	call   801039b0 <myproc>
80105bbd:	85 c0                	test   %eax,%eax
80105bbf:	74 1d                	je     80105bde <trap+0x9e>
80105bc1:	e8 ea dd ff ff       	call   801039b0 <myproc>
...
80105bf0:	e8 bb dd ff ff       	call   801039b0 <myproc>
...
80105c10:	e8 7b dd ff ff       	call   80103990 <cpuid>
...
80105c21:	e8 8a dd ff ff       	call   801039b0 <myproc>
80105c26:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c29:	e8 82 dd ff ff       	call   801039b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105c45:	68 a4 7b 10 80       	push   $0x80107ba4
80105c4a:	e8 51 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105c4f:	83 c4 20             	add    $0x20,%esp
80105c52:	e8 59 dd ff ff       	call   801039b0 <myproc>
80105c57:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c5e:	e8 4d dd ff ff       	call   801039b0 <myproc>
...
80105c74:	0f 85 3e ff ff ff    	jne    80105bb8 <trap+0x78>
    yield();
80105c7a:	e8 31 e4 ff ff       	call   801040b0 <yield>
...
80105c8f:	e8 fc dc ff ff       	call   80103990 <cpuid>
80105c94:	57                   	push   %edi
80105c95:	56                   	push   %esi
80105c96:	50                   	push   %eax
80105c97:	68 4c 7b 10 80       	push   $0x80107b4c
80105c9c:	e8 ff a9 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105ca1:	e8 6a cc ff ff       	call   80102910 <lapiceoi>
    break;
80105ca6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ca9:	e8 02 dd ff ff       	call   801039b0 <myproc>
...
80105cbf:	90                   	nop
    if(myproc()->killed)
80105cc0:	e8 eb dc ff ff       	call   801039b0 <myproc>
...
80105cd5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105cd8:	e8 03 ef ff ff       	call   80104be0 <syscall>
    if(myproc()->killed)
80105cdd:	e8 ce dc ff ff       	call   801039b0 <myproc>
...
80105cf3:	5d                   	pop    %ebp
      exit();
80105cf4:	e9 57 e1 ff ff       	jmp    80103e50 <exit>
...
80105d05:	e8 06 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d0a:	e8 a1 dc ff ff       	call   801039b0 <myproc>
...
80105d1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105d20:	e8 ab ca ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105d25:	e8 e6 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d2a:	e8 81 dc ff ff       	call   801039b0 <myproc>
...
80105d3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105d40:	e8 4b dc ff ff       	call   80103990 <cpuid>
80105d45:	85 c0                	test   %eax,%eax
80105d47:	0f 85 28 fe ff ff    	jne    80105b75 <trap+0x35>
      acquire(&tickslock);
80105d4d:	83 ec 0c             	sub    $0xc,%esp
80105d50:	68 80 41 11 80       	push   $0x80114180
80105d55:	e8 c6 e9 ff ff       	call   80104720 <acquire>
      wakeup(&ticks);
80105d5a:	c7 04 24 60 41 11 80 	movl   $0x80114160,(%esp)
      ticks++;
80105d61:	83 05 60 41 11 80 01 	addl   $0x1,0x80114160
      wakeup(&ticks);
80105d68:	e8 53 e4 ff ff       	call   801041c0 <wakeup>
      release(&tickslock);
80105d6d:	c7 04 24 80 41 11 80 	movl   $0x80114180,(%esp)
80105d74:	e8 47 e9 ff ff       	call   801046c0 <release>
...
{
  if(!uart)
80105dd0:	a1 c0 49 11 80       	mov    0x801149c0,%eax
...
80105e57:	74 78                	je     80105ed1 <uartinit+0xd1>
  uart = 1;
80105e59:	c7 05 c0 49 11 80 01 	movl   $0x1,0x801149c0
80105e60:	00 00 00 
...
80105e6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e6f:	bf 68 7c 10 80       	mov    $0x80107c68,%edi
...
80105e89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e90:	a1 c0 49 11 80       	mov    0x801149c0,%eax
...
80105ee0 <uartputc>:
  if(!uart)
80105ee0:	a1 c0 49 11 80       	mov    0x801149c0,%eax
...
80105f05:	e8 26 ca ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105f57:	6a 00                	push   $0x0
  jmp alltraps
80105f59:	e9 01 fb ff ff       	jmp    80105a5f <alltraps>
...
80105f60:	6a 01                	push   $0x1
  jmp alltraps
80105f62:	e9 f8 fa ff ff       	jmp    80105a5f <alltraps>
...
80105f69:	6a 02                	push   $0x2
  jmp alltraps
80105f6b:	e9 ef fa ff ff       	jmp    80105a5f <alltraps>
...
80105f72:	6a 03                	push   $0x3
  jmp alltraps
80105f74:	e9 e6 fa ff ff       	jmp    80105a5f <alltraps>
...
80105f7b:	6a 04                	push   $0x4
  jmp alltraps
80105f7d:	e9 dd fa ff ff       	jmp    80105a5f <alltraps>
...
80105f84:	6a 05                	push   $0x5
  jmp alltraps
80105f86:	e9 d4 fa ff ff       	jmp    80105a5f <alltraps>
...
80105f8d:	6a 06                	push   $0x6
  jmp alltraps
80105f8f:	e9 cb fa ff ff       	jmp    80105a5f <alltraps>
...
80105f96:	6a 07                	push   $0x7
  jmp alltraps
80105f98:	e9 c2 fa ff ff       	jmp    80105a5f <alltraps>
...
80105f9d:	6a 08                	push   $0x8
  jmp alltraps
80105f9f:	e9 bb fa ff ff       	jmp    80105a5f <alltraps>
...
80105fa6:	6a 09                	push   $0x9
  jmp alltraps
80105fa8:	e9 b2 fa ff ff       	jmp    80105a5f <alltraps>
...
80105fad:	6a 0a                	push   $0xa
  jmp alltraps
80105faf:	e9 ab fa ff ff       	jmp    80105a5f <alltraps>
...
80105fb4:	6a 0b                	push   $0xb
  jmp alltraps
80105fb6:	e9 a4 fa ff ff       	jmp    80105a5f <alltraps>
...
80105fbb:	6a 0c                	push   $0xc
  jmp alltraps
80105fbd:	e9 9d fa ff ff       	jmp    80105a5f <alltraps>
...
80105fc2:	6a 0d                	push   $0xd
  jmp alltraps
80105fc4:	e9 96 fa ff ff       	jmp    80105a5f <alltraps>
...
80105fc9:	6a 0e                	push   $0xe
  jmp alltraps
80105fcb:	e9 8f fa ff ff       	jmp    80105a5f <alltraps>
...
80105fd2:	6a 0f                	push   $0xf
  jmp alltraps
80105fd4:	e9 86 fa ff ff       	jmp    80105a5f <alltraps>
...
80105fdb:	6a 10                	push   $0x10
  jmp alltraps
80105fdd:	e9 7d fa ff ff       	jmp    80105a5f <alltraps>
...
80105fe2:	6a 11                	push   $0x11
  jmp alltraps
80105fe4:	e9 76 fa ff ff       	jmp    80105a5f <alltraps>
...
80105feb:	6a 12                	push   $0x12
  jmp alltraps
80105fed:	e9 6d fa ff ff       	jmp    80105a5f <alltraps>
...
80105ff4:	6a 13                	push   $0x13
  jmp alltraps
80105ff6:	e9 64 fa ff ff       	jmp    80105a5f <alltraps>
...
80105ffd:	6a 14                	push   $0x14
  jmp alltraps
80105fff:	e9 5b fa ff ff       	jmp    80105a5f <alltraps>
...
80106006:	6a 15                	push   $0x15
  jmp alltraps
80106008:	e9 52 fa ff ff       	jmp    80105a5f <alltraps>
...
8010600f:	6a 16                	push   $0x16
  jmp alltraps
80106011:	e9 49 fa ff ff       	jmp    80105a5f <alltraps>
...
80106018:	6a 17                	push   $0x17
  jmp alltraps
8010601a:	e9 40 fa ff ff       	jmp    80105a5f <alltraps>
...
80106021:	6a 18                	push   $0x18
  jmp alltraps
80106023:	e9 37 fa ff ff       	jmp    80105a5f <alltraps>
...
8010602a:	6a 19                	push   $0x19
  jmp alltraps
8010602c:	e9 2e fa ff ff       	jmp    80105a5f <alltraps>
...
80106033:	6a 1a                	push   $0x1a
  jmp alltraps
80106035:	e9 25 fa ff ff       	jmp    80105a5f <alltraps>
...
8010603c:	6a 1b                	push   $0x1b
  jmp alltraps
8010603e:	e9 1c fa ff ff       	jmp    80105a5f <alltraps>
...
80106045:	6a 1c                	push   $0x1c
  jmp alltraps
80106047:	e9 13 fa ff ff       	jmp    80105a5f <alltraps>
...
8010604e:	6a 1d                	push   $0x1d
  jmp alltraps
80106050:	e9 0a fa ff ff       	jmp    80105a5f <alltraps>
...
80106057:	6a 1e                	push   $0x1e
  jmp alltraps
80106059:	e9 01 fa ff ff       	jmp    80105a5f <alltraps>
...
80106060:	6a 1f                	push   $0x1f
  jmp alltraps
80106062:	e9 f8 f9 ff ff       	jmp    80105a5f <alltraps>
...
80106069:	6a 20                	push   $0x20
  jmp alltraps
8010606b:	e9 ef f9 ff ff       	jmp    80105a5f <alltraps>
...
80106072:	6a 21                	push   $0x21
  jmp alltraps
80106074:	e9 e6 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010607b:	6a 22                	push   $0x22
  jmp alltraps
8010607d:	e9 dd f9 ff ff       	jmp    80105a5f <alltraps>
...
80106084:	6a 23                	push   $0x23
  jmp alltraps
80106086:	e9 d4 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010608d:	6a 24                	push   $0x24
  jmp alltraps
8010608f:	e9 cb f9 ff ff       	jmp    80105a5f <alltraps>
...
80106096:	6a 25                	push   $0x25
  jmp alltraps
80106098:	e9 c2 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010609f:	6a 26                	push   $0x26
  jmp alltraps
801060a1:	e9 b9 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060a8:	6a 27                	push   $0x27
  jmp alltraps
801060aa:	e9 b0 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060b1:	6a 28                	push   $0x28
  jmp alltraps
801060b3:	e9 a7 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060ba:	6a 29                	push   $0x29
  jmp alltraps
801060bc:	e9 9e f9 ff ff       	jmp    80105a5f <alltraps>
...
801060c3:	6a 2a                	push   $0x2a
  jmp alltraps
801060c5:	e9 95 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060cc:	6a 2b                	push   $0x2b
  jmp alltraps
801060ce:	e9 8c f9 ff ff       	jmp    80105a5f <alltraps>
...
801060d5:	6a 2c                	push   $0x2c
  jmp alltraps
801060d7:	e9 83 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060de:	6a 2d                	push   $0x2d
  jmp alltraps
801060e0:	e9 7a f9 ff ff       	jmp    80105a5f <alltraps>
...
801060e7:	6a 2e                	push   $0x2e
  jmp alltraps
801060e9:	e9 71 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060f0:	6a 2f                	push   $0x2f
  jmp alltraps
801060f2:	e9 68 f9 ff ff       	jmp    80105a5f <alltraps>
...
801060f9:	6a 30                	push   $0x30
  jmp alltraps
801060fb:	e9 5f f9 ff ff       	jmp    80105a5f <alltraps>
...
80106102:	6a 31                	push   $0x31
  jmp alltraps
80106104:	e9 56 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010610b:	6a 32                	push   $0x32
  jmp alltraps
8010610d:	e9 4d f9 ff ff       	jmp    80105a5f <alltraps>
...
80106114:	6a 33                	push   $0x33
  jmp alltraps
80106116:	e9 44 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010611d:	6a 34                	push   $0x34
  jmp alltraps
8010611f:	e9 3b f9 ff ff       	jmp    80105a5f <alltraps>
...
80106126:	6a 35                	push   $0x35
  jmp alltraps
80106128:	e9 32 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010612f:	6a 36                	push   $0x36
  jmp alltraps
80106131:	e9 29 f9 ff ff       	jmp    80105a5f <alltraps>
...
80106138:	6a 37                	push   $0x37
  jmp alltraps
8010613a:	e9 20 f9 ff ff       	jmp    80105a5f <alltraps>
...
80106141:	6a 38                	push   $0x38
  jmp alltraps
80106143:	e9 17 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010614a:	6a 39                	push   $0x39
  jmp alltraps
8010614c:	e9 0e f9 ff ff       	jmp    80105a5f <alltraps>
...
80106153:	6a 3a                	push   $0x3a
  jmp alltraps
80106155:	e9 05 f9 ff ff       	jmp    80105a5f <alltraps>
...
8010615c:	6a 3b                	push   $0x3b
  jmp alltraps
8010615e:	e9 fc f8 ff ff       	jmp    80105a5f <alltraps>
...
80106165:	6a 3c                	push   $0x3c
  jmp alltraps
80106167:	e9 f3 f8 ff ff       	jmp    80105a5f <alltraps>
...
8010616e:	6a 3d                	push   $0x3d
  jmp alltraps
80106170:	e9 ea f8 ff ff       	jmp    80105a5f <alltraps>
...
80106177:	6a 3e                	push   $0x3e
  jmp alltraps
80106179:	e9 e1 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106180:	6a 3f                	push   $0x3f
  jmp alltraps
80106182:	e9 d8 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106189:	6a 40                	push   $0x40
  jmp alltraps
8010618b:	e9 cf f8 ff ff       	jmp    80105a5f <alltraps>
...
80106192:	6a 41                	push   $0x41
  jmp alltraps
80106194:	e9 c6 f8 ff ff       	jmp    80105a5f <alltraps>
...
8010619b:	6a 42                	push   $0x42
  jmp alltraps
8010619d:	e9 bd f8 ff ff       	jmp    80105a5f <alltraps>
...
801061a4:	6a 43                	push   $0x43
  jmp alltraps
801061a6:	e9 b4 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061ad:	6a 44                	push   $0x44
  jmp alltraps
801061af:	e9 ab f8 ff ff       	jmp    80105a5f <alltraps>
...
801061b6:	6a 45                	push   $0x45
  jmp alltraps
801061b8:	e9 a2 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061bf:	6a 46                	push   $0x46
  jmp alltraps
801061c1:	e9 99 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061c8:	6a 47                	push   $0x47
  jmp alltraps
801061ca:	e9 90 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061d1:	6a 48                	push   $0x48
  jmp alltraps
801061d3:	e9 87 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061da:	6a 49                	push   $0x49
  jmp alltraps
801061dc:	e9 7e f8 ff ff       	jmp    80105a5f <alltraps>
...
801061e3:	6a 4a                	push   $0x4a
  jmp alltraps
801061e5:	e9 75 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061ec:	6a 4b                	push   $0x4b
  jmp alltraps
801061ee:	e9 6c f8 ff ff       	jmp    80105a5f <alltraps>
...
801061f5:	6a 4c                	push   $0x4c
  jmp alltraps
801061f7:	e9 63 f8 ff ff       	jmp    80105a5f <alltraps>
...
801061fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106200:	e9 5a f8 ff ff       	jmp    80105a5f <alltraps>
...
80106207:	6a 4e                	push   $0x4e
  jmp alltraps
80106209:	e9 51 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106210:	6a 4f                	push   $0x4f
  jmp alltraps
80106212:	e9 48 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106219:	6a 50                	push   $0x50
  jmp alltraps
8010621b:	e9 3f f8 ff ff       	jmp    80105a5f <alltraps>
...
80106222:	6a 51                	push   $0x51
  jmp alltraps
80106224:	e9 36 f8 ff ff       	jmp    80105a5f <alltraps>
...
8010622b:	6a 52                	push   $0x52
  jmp alltraps
8010622d:	e9 2d f8 ff ff       	jmp    80105a5f <alltraps>
...
80106234:	6a 53                	push   $0x53
  jmp alltraps
80106236:	e9 24 f8 ff ff       	jmp    80105a5f <alltraps>
...
8010623d:	6a 54                	push   $0x54
  jmp alltraps
8010623f:	e9 1b f8 ff ff       	jmp    80105a5f <alltraps>
...
80106246:	6a 55                	push   $0x55
  jmp alltraps
80106248:	e9 12 f8 ff ff       	jmp    80105a5f <alltraps>
...
8010624f:	6a 56                	push   $0x56
  jmp alltraps
80106251:	e9 09 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106258:	6a 57                	push   $0x57
  jmp alltraps
8010625a:	e9 00 f8 ff ff       	jmp    80105a5f <alltraps>
...
80106261:	6a 58                	push   $0x58
  jmp alltraps
80106263:	e9 f7 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010626a:	6a 59                	push   $0x59
  jmp alltraps
8010626c:	e9 ee f7 ff ff       	jmp    80105a5f <alltraps>
...
80106273:	6a 5a                	push   $0x5a
  jmp alltraps
80106275:	e9 e5 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010627c:	6a 5b                	push   $0x5b
  jmp alltraps
8010627e:	e9 dc f7 ff ff       	jmp    80105a5f <alltraps>
...
80106285:	6a 5c                	push   $0x5c
  jmp alltraps
80106287:	e9 d3 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010628e:	6a 5d                	push   $0x5d
  jmp alltraps
80106290:	e9 ca f7 ff ff       	jmp    80105a5f <alltraps>
...
80106297:	6a 5e                	push   $0x5e
  jmp alltraps
80106299:	e9 c1 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062a0:	6a 5f                	push   $0x5f
  jmp alltraps
801062a2:	e9 b8 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062a9:	6a 60                	push   $0x60
  jmp alltraps
801062ab:	e9 af f7 ff ff       	jmp    80105a5f <alltraps>
...
801062b2:	6a 61                	push   $0x61
  jmp alltraps
801062b4:	e9 a6 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062bb:	6a 62                	push   $0x62
  jmp alltraps
801062bd:	e9 9d f7 ff ff       	jmp    80105a5f <alltraps>
...
801062c4:	6a 63                	push   $0x63
  jmp alltraps
801062c6:	e9 94 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062cd:	6a 64                	push   $0x64
  jmp alltraps
801062cf:	e9 8b f7 ff ff       	jmp    80105a5f <alltraps>
...
801062d6:	6a 65                	push   $0x65
  jmp alltraps
801062d8:	e9 82 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062df:	6a 66                	push   $0x66
  jmp alltraps
801062e1:	e9 79 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062e8:	6a 67                	push   $0x67
  jmp alltraps
801062ea:	e9 70 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062f1:	6a 68                	push   $0x68
  jmp alltraps
801062f3:	e9 67 f7 ff ff       	jmp    80105a5f <alltraps>
...
801062fa:	6a 69                	push   $0x69
  jmp alltraps
801062fc:	e9 5e f7 ff ff       	jmp    80105a5f <alltraps>
...
80106303:	6a 6a                	push   $0x6a
  jmp alltraps
80106305:	e9 55 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010630c:	6a 6b                	push   $0x6b
  jmp alltraps
8010630e:	e9 4c f7 ff ff       	jmp    80105a5f <alltraps>
...
80106315:	6a 6c                	push   $0x6c
  jmp alltraps
80106317:	e9 43 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010631e:	6a 6d                	push   $0x6d
  jmp alltraps
80106320:	e9 3a f7 ff ff       	jmp    80105a5f <alltraps>
...
80106327:	6a 6e                	push   $0x6e
  jmp alltraps
80106329:	e9 31 f7 ff ff       	jmp    80105a5f <alltraps>
...
80106330:	6a 6f                	push   $0x6f
  jmp alltraps
80106332:	e9 28 f7 ff ff       	jmp    80105a5f <alltraps>
...
80106339:	6a 70                	push   $0x70
  jmp alltraps
8010633b:	e9 1f f7 ff ff       	jmp    80105a5f <alltraps>
...
80106342:	6a 71                	push   $0x71
  jmp alltraps
80106344:	e9 16 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010634b:	6a 72                	push   $0x72
  jmp alltraps
8010634d:	e9 0d f7 ff ff       	jmp    80105a5f <alltraps>
...
80106354:	6a 73                	push   $0x73
  jmp alltraps
80106356:	e9 04 f7 ff ff       	jmp    80105a5f <alltraps>
...
8010635d:	6a 74                	push   $0x74
  jmp alltraps
8010635f:	e9 fb f6 ff ff       	jmp    80105a5f <alltraps>
...
80106366:	6a 75                	push   $0x75
  jmp alltraps
80106368:	e9 f2 f6 ff ff       	jmp    80105a5f <alltraps>
...
8010636f:	6a 76                	push   $0x76
  jmp alltraps
80106371:	e9 e9 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106378:	6a 77                	push   $0x77
  jmp alltraps
8010637a:	e9 e0 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106381:	6a 78                	push   $0x78
  jmp alltraps
80106383:	e9 d7 f6 ff ff       	jmp    80105a5f <alltraps>
...
8010638a:	6a 79                	push   $0x79
  jmp alltraps
8010638c:	e9 ce f6 ff ff       	jmp    80105a5f <alltraps>
...
80106393:	6a 7a                	push   $0x7a
  jmp alltraps
80106395:	e9 c5 f6 ff ff       	jmp    80105a5f <alltraps>
...
8010639c:	6a 7b                	push   $0x7b
  jmp alltraps
8010639e:	e9 bc f6 ff ff       	jmp    80105a5f <alltraps>
...
801063a5:	6a 7c                	push   $0x7c
  jmp alltraps
801063a7:	e9 b3 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063ae:	6a 7d                	push   $0x7d
  jmp alltraps
801063b0:	e9 aa f6 ff ff       	jmp    80105a5f <alltraps>
...
801063b7:	6a 7e                	push   $0x7e
  jmp alltraps
801063b9:	e9 a1 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063c0:	6a 7f                	push   $0x7f
  jmp alltraps
801063c2:	e9 98 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063ce:	e9 8c f6 ff ff       	jmp    80105a5f <alltraps>
...
801063d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063da:	e9 80 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063e6:	e9 74 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063f2:	e9 68 f6 ff ff       	jmp    80105a5f <alltraps>
...
801063f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063fe:	e9 5c f6 ff ff       	jmp    80105a5f <alltraps>
...
80106405:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010640a:	e9 50 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106411:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106416:	e9 44 f6 ff ff       	jmp    80105a5f <alltraps>
...
8010641d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106422:	e9 38 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106429:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010642e:	e9 2c f6 ff ff       	jmp    80105a5f <alltraps>
...
80106435:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010643a:	e9 20 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106441:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106446:	e9 14 f6 ff ff       	jmp    80105a5f <alltraps>
...
8010644d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106452:	e9 08 f6 ff ff       	jmp    80105a5f <alltraps>
...
80106459:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010645e:	e9 fc f5 ff ff       	jmp    80105a5f <alltraps>
...
80106465:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010646a:	e9 f0 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106471:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106476:	e9 e4 f5 ff ff       	jmp    80105a5f <alltraps>
...
8010647d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106482:	e9 d8 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106489:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010648e:	e9 cc f5 ff ff       	jmp    80105a5f <alltraps>
...
80106495:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010649a:	e9 c0 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064a6:	e9 b4 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064b2:	e9 a8 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064be:	e9 9c f5 ff ff       	jmp    80105a5f <alltraps>
...
801064c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ca:	e9 90 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064d6:	e9 84 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064e2:	e9 78 f5 ff ff       	jmp    80105a5f <alltraps>
...
801064e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ee:	e9 6c f5 ff ff       	jmp    80105a5f <alltraps>
...
801064f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064fa:	e9 60 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106501:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106506:	e9 54 f5 ff ff       	jmp    80105a5f <alltraps>
...
8010650d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106512:	e9 48 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106519:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010651e:	e9 3c f5 ff ff       	jmp    80105a5f <alltraps>
...
80106525:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010652a:	e9 30 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106531:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106536:	e9 24 f5 ff ff       	jmp    80105a5f <alltraps>
...
8010653d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106542:	e9 18 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106549:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010654e:	e9 0c f5 ff ff       	jmp    80105a5f <alltraps>
...
80106555:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010655a:	e9 00 f5 ff ff       	jmp    80105a5f <alltraps>
...
80106561:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106566:	e9 f4 f4 ff ff       	jmp    80105a5f <alltraps>
...
8010656d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106572:	e9 e8 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106579:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010657e:	e9 dc f4 ff ff       	jmp    80105a5f <alltraps>
...
80106585:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010658a:	e9 d0 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106591:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106596:	e9 c4 f4 ff ff       	jmp    80105a5f <alltraps>
...
8010659d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065a2:	e9 b8 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065ae:	e9 ac f4 ff ff       	jmp    80105a5f <alltraps>
...
801065b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065ba:	e9 a0 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065c6:	e9 94 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065d2:	e9 88 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065de:	e9 7c f4 ff ff       	jmp    80105a5f <alltraps>
...
801065e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ea:	e9 70 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065f6:	e9 64 f4 ff ff       	jmp    80105a5f <alltraps>
...
801065fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106602:	e9 58 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106609:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010660e:	e9 4c f4 ff ff       	jmp    80105a5f <alltraps>
...
80106615:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010661a:	e9 40 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106621:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106626:	e9 34 f4 ff ff       	jmp    80105a5f <alltraps>
...
8010662d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106632:	e9 28 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106639:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010663e:	e9 1c f4 ff ff       	jmp    80105a5f <alltraps>
...
80106645:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010664a:	e9 10 f4 ff ff       	jmp    80105a5f <alltraps>
...
80106651:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106656:	e9 04 f4 ff ff       	jmp    80105a5f <alltraps>
...
8010665d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106662:	e9 f8 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106669:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010666e:	e9 ec f3 ff ff       	jmp    80105a5f <alltraps>
...
80106675:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010667a:	e9 e0 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106681:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106686:	e9 d4 f3 ff ff       	jmp    80105a5f <alltraps>
...
8010668d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106692:	e9 c8 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106699:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010669e:	e9 bc f3 ff ff       	jmp    80105a5f <alltraps>
...
801066a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066aa:	e9 b0 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066b6:	e9 a4 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066c2:	e9 98 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066ce:	e9 8c f3 ff ff       	jmp    80105a5f <alltraps>
...
801066d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066da:	e9 80 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066e6:	e9 74 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066f2:	e9 68 f3 ff ff       	jmp    80105a5f <alltraps>
...
801066f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066fe:	e9 5c f3 ff ff       	jmp    80105a5f <alltraps>
...
80106705:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010670a:	e9 50 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106711:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106716:	e9 44 f3 ff ff       	jmp    80105a5f <alltraps>
...
8010671d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106722:	e9 38 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106729:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010672e:	e9 2c f3 ff ff       	jmp    80105a5f <alltraps>
...
80106735:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010673a:	e9 20 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106741:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106746:	e9 14 f3 ff ff       	jmp    80105a5f <alltraps>
...
8010674d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106752:	e9 08 f3 ff ff       	jmp    80105a5f <alltraps>
...
80106759:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010675e:	e9 fc f2 ff ff       	jmp    80105a5f <alltraps>
...
80106765:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010676a:	e9 f0 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106771:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106776:	e9 e4 f2 ff ff       	jmp    80105a5f <alltraps>
...
8010677d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106782:	e9 d8 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106789:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010678e:	e9 cc f2 ff ff       	jmp    80105a5f <alltraps>
...
80106795:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010679a:	e9 c0 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067a6:	e9 b4 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067b2:	e9 a8 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067be:	e9 9c f2 ff ff       	jmp    80105a5f <alltraps>
...
801067c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ca:	e9 90 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067d6:	e9 84 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067e2:	e9 78 f2 ff ff       	jmp    80105a5f <alltraps>
...
801067e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ee:	e9 6c f2 ff ff       	jmp    80105a5f <alltraps>
...
801067f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067fa:	e9 60 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106801:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106806:	e9 54 f2 ff ff       	jmp    80105a5f <alltraps>
...
8010680d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106812:	e9 48 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106819:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010681e:	e9 3c f2 ff ff       	jmp    80105a5f <alltraps>
...
80106825:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010682a:	e9 30 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106831:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106836:	e9 24 f2 ff ff       	jmp    80105a5f <alltraps>
...
8010683d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106842:	e9 18 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106849:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010684e:	e9 0c f2 ff ff       	jmp    80105a5f <alltraps>
...
80106855:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010685a:	e9 00 f2 ff ff       	jmp    80105a5f <alltraps>
...
80106861:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106866:	e9 f4 f1 ff ff       	jmp    80105a5f <alltraps>
...
8010686d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106872:	e9 e8 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106879:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010687e:	e9 dc f1 ff ff       	jmp    80105a5f <alltraps>
...
80106885:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010688a:	e9 d0 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106891:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106896:	e9 c4 f1 ff ff       	jmp    80105a5f <alltraps>
...
8010689d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068a2:	e9 b8 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068ae:	e9 ac f1 ff ff       	jmp    80105a5f <alltraps>
...
801068b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068ba:	e9 a0 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068c6:	e9 94 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068d2:	e9 88 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068de:	e9 7c f1 ff ff       	jmp    80105a5f <alltraps>
...
801068e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ea:	e9 70 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068f6:	e9 64 f1 ff ff       	jmp    80105a5f <alltraps>
...
801068fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106902:	e9 58 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106909:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010690e:	e9 4c f1 ff ff       	jmp    80105a5f <alltraps>
...
80106915:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010691a:	e9 40 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106921:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106926:	e9 34 f1 ff ff       	jmp    80105a5f <alltraps>
...
8010692d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106932:	e9 28 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106939:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010693e:	e9 1c f1 ff ff       	jmp    80105a5f <alltraps>
...
80106945:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010694a:	e9 10 f1 ff ff       	jmp    80105a5f <alltraps>
...
80106951:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106956:	e9 04 f1 ff ff       	jmp    80105a5f <alltraps>
...
8010695d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106962:	e9 f8 f0 ff ff       	jmp    80105a5f <alltraps>
...
80106969:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010696e:	e9 ec f0 ff ff       	jmp    80105a5f <alltraps>
...
80106975:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010697a:	e9 e0 f0 ff ff       	jmp    80105a5f <alltraps>
...
80106981:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106986:	e9 d4 f0 ff ff       	jmp    80105a5f <alltraps>
...
8010698d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106992:	e9 c8 f0 ff ff       	jmp    80105a5f <alltraps>
...
80106999:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010699e:	e9 bc f0 ff ff       	jmp    80105a5f <alltraps>
...
801069a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069aa:	e9 b0 f0 ff ff       	jmp    80105a5f <alltraps>
...
801069b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069b6:	e9 a4 f0 ff ff       	jmp    80105a5f <alltraps>
...
801069bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069c2:	e9 98 f0 ff ff       	jmp    80105a5f <alltraps>
...
80106a59:	e8 62 ba ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
80106afe:	e8 7d bb ff ff       	call   80102680 <kalloc>
...
80106b15:	e8 c6 dc ff ff       	call   801047e0 <memset>
...
80106b5d:	68 70 7c 10 80       	push   $0x80107c70
...
80106b73:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b76:	e8 15 ce ff ff       	call   80103990 <cpuid>
  pd[0] = size-1;
...
80106c00:	a1 c4 49 11 80       	mov    0x801149c4,%eax
...
80106c34:	0f 84 c2 00 00 00    	je     80106cfc <switchuvm+0xec>
  pushcli();
80106c3a:	e8 91 d9 ff ff       	call   801045d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c3f:	e8 ec cc ff ff       	call   80103930 <mycpu>
80106c44:	89 c3                	mov    %eax,%ebx
80106c46:	e8 e5 cc ff ff       	call   80103930 <mycpu>
80106c4b:	89 c7                	mov    %eax,%edi
80106c4d:	e8 de cc ff ff       	call   80103930 <mycpu>
80106c52:	83 c7 08             	add    $0x8,%edi
80106c55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c58:	e8 d3 cc ff ff       	call   80103930 <mycpu>
...
80106d3b:	77 4b                	ja     80106d88 <inituvm+0x68>
  mem = kalloc();
80106d3d:	e8 3e b9 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d4f:	e8 8c da ff ff       	call   801047e0 <memset>
...
80106d82:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d83:	e9 f8 da ff ff       	jmp    80104880 <memmove>
    panic("inituvm: more than a page");
80106d88:	83 ec 0c             	sub    $0xc,%esp
80106d8b:	68 b5 7c 10 80       	push   $0x80107cb5
...
80106df0:	68 cf 7c 10 80       	push   $0x80107ccf
...
80106e78:	68 70 7d 10 80       	push   $0x80107d70
...
80106edb:	e8 00 d9 ff ff       	call   801047e0 <memset>
...
80106f09:	76 48                	jbe    80106f53 <allocuvm+0xc3>
    mem = kalloc();
80106f0b:	e8 70 b7 ff ff       	call   80102680 <kalloc>
...
80106f19:	68 ed 7c 10 80       	push   $0x80107ced
...
80106f7b:	68 05 7d 10 80       	push   $0x80107d05
...
80106fa0:	e8 1b b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
8010703e:	e8 7d b4 ff ff       	call   801024c0 <kfree>
...
80107053:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107054:	e9 67 b4 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107059:	83 ec 0c             	sub    $0xc,%esp
8010705c:	68 21 7d 10 80       	push   $0x80107d21
...
80107075:	e8 06 b6 ff ff       	call   80102680 <kalloc>
...
80107090:	e8 4b d7 ff ff       	call   801047e0 <memset>
...
801070fb:	a3 c4 49 11 80       	mov    %eax,0x801149c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010712c:	68 32 7d 10 80       	push   $0x80107d32
...
801071a2:	68 3c 7d 10 80       	push   $0x80107d3c
...
80107200:	e8 7b d6 ff ff       	call   80104880 <memmove>
...
8010724c:	e8 6f b2 ff ff       	call   801024c0 <kfree>
      goto bad;
...
80107277:	68 56 7d 10 80       	push   $0x80107d56
...
80107330:	e8 4b d5 ff ff       	call   80104880 <memmove>
    len -= n;
    buf += n;
